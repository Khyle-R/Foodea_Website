              ...
              <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                      ...
                      <a href="#" class="list-group-item list-group-item-action py-3 lh-sm">
                        <div class="d-flex w-100 align-items-center justify-content-between">
                          ...
                          <div class="template-demo">
                            <button type="button" class="btn btn-outline-danger btn-fw btn-rounded">View</button>
                            <button type="button" class="btn btn-danger btn-rounded btn-fw">Upload</button>
                          </div>
                    ...
                    <div class="template-demo text-center">
                        <button type="button" class="btn btn-outline-danger btn-fw btn-rounded btn-lg">Cancel</button>
                        <button type="button" class="btn btn-danger btn-rounded btn-fw btn-lg">Submit</button>
                      </div>
                        </div>
                      </div>
                    </div>
