...
<html lang="en">
  <head>
    ...
    <!-- endinject -->
    <!-- Layout styles -->
    <link rel="stylesheet" href="assets/css/Admin_Businessinformation.css" />
    <!-- End layout styles -->
              ...
              <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                     ...
                     <div class="card-header">
                      ...
                      <a class="btn btn-link text-decoration-none get-started-btn " style="font-size: 15px;" href="admin_personalinfo.html">Profile Information</a>
                      <a class="btn btn-link text-decoration-none get-started-btn " style="font-size: 15px;" href="admin_businessinfo.html">Business Information</a>
                    ...
                    <form class="form-sample">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                              <p class="text-dark" style="padding-left: 10px;">Business Name</p>
                              <div class="col-sm-10">
                                <class type="text" class="form-control" style="border-radius: 10px;">
                                <p class="text-dark" style="padding-left: 5px;">Foodea</p>
                              </div>
                            </div>
                          </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <class type="text" class="form-control" style="border-radius: 10px;">
                              <p class="text-dark" style="padding-left: 5px;">187</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <class type="text" class="form-control" style="border-radius: 10px;">
                                <p class="text-dark" style="padding-left: 5px;">Company</p>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <class type="text" class="form-control" style="border-radius: 10px;">
                              <p class="text-dark" style="padding-left: 5px;">1</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            <p class="text-dark" style="padding-left: 15px;">Business Adress</p>
                            <div class="col-sm-10" style="padding-left: 15px;">
                              <class type="text" class="form-control" style="border-radius: 10px;">
                              <p class="text-dark" style="padding-left: 5px;">Blk 1 lot 6 mangas st.</p>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            <p class="text-dark" style="padding-left: 15px;">City &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp </p>
                            <div class="col-sm-10">
                              <class type="text" class="form-control" style="border-radius: 10px;">
                              <p class="text-dark" style="padding-left: 5px;">Caloocan City</p>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
