    ...
    $h = {
        ...
        getZoomPlaceholder: function () { // used to prevent 404 errors in URL parsing
            var src = $h.SCRIPT_SRC,
                srcPath, zoomVar = '?kvTemp__2873389129__=';
            if (!src) {
                return zoomVar;
            }
    ...
    FileInput.prototype = {
        ...
        _setZoomContent: function ($frame, navigate) {
            ...
            if (zoomData) {
                ...
                parsed = $zoomPreview.html().replace(self.zoomPlaceholder, '').setTokens({
                    zoomData: zoomData
                });
        ...
        _zoomSlideShow: function (dir, previewId) {
            var self = this,
                ...
                $targFrame, i,
                $thumb, thumbsData = self.getFrames().toArray(),
                thumbs = [],
        ...
        _ajaxSubmit: function (fnBefore, fnSuccess, fnComplete, fnError, formdata, fileId, index, vUrl) {
            var self = this,
                settings, defaults, data, tm = self.taskManager;
        ...
        _initUploadSuccess: function (out, $thumb, allFiles) {
            var self = this,
                append, data, index, $div, content, config, tags, id, i;
        ...
        _resetCaption: function () {
            ...
            setTimeout(function () {
                var cap = '',
                    n, chk = self.previewCache.count(true),
        ...
        _handleRotation: function ($el, $content, angle) {
            var self = this,
                ...
                scale = 1,
                elContent = $content[0],
                quadrant, transform, h, w,
                wNew, $parent = $content.parent(),
                hParent, wParent, $body = $('body'),
        ...
        _generatePreviewTemplate: function (
            ...
            var self = this,
                ...
                isIconic, ext = filename.split('.').pop().toLowerCase(),
                screenW = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth,
                config, title = caption,
                alt = caption,
                typeCss = 'type-default',
                getContent, addFrameCss,
        ...
        _isValidSize: function (size, type, $image, $thumb, filename, params) {
            var self = this,
                msg, dim, $img, tag = size === 'Small' ? 'min' : 'max',
            ...
            self._showFileError(msg.setTokens({
                'name': filename,
                'size': limit,
                'dimension': dim
            }), params);
        ...
        readFiles: function (files) {
            ...
            readFile = function (i) {
                ...
                self.lock(true);
                var file = files[i],
                    id, previewId, fileProcessed,
                    fSize = (file && file.size || 0),
                    sizeHuman = self._getSize(fSize, true),
                    j, msg,
                    fnImage = settings.image,
                    chk, typ, typ1, typ2, caption, fileSize = fSize / self.bytesToKB,
                    fileExtExpr = '',
                    previewData, fileCount = 0,
                    strTypes = '',
                    fileId, canLoad,
                    fileReaderAborted = false,
                    func, knownTypes = 0,
                    isImage, processFileLoaded, initFileData;
                ...
                reader.onload = function (theFile) {
                    var hex, fileInfo, fileData, byte, bytes = [],
                        contents, mime,
