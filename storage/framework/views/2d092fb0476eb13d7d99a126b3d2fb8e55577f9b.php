                    ...
                    <div class="col-12 col-sm-8 col-md-7 col-lg-6 m-auto">
                        <div class="card border-0 shadow">
                            <div class="card-body px-5 ">
                                ...
                                <form method="post" action="<?php echo e(route('login.LoginAdmin')); ?>" class="mt-4">
                                   <?php echo csrf_field(); ?>
                                    ...
                                    <input
                                        ...
                                        value="<?php echo e(Cookie::get('superadmin_email')); ?>"
                                    />
                                       <span
                                        class="error">
...
unset($__errorArgs, $__bag); ?></span>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <input
                                            ...
                                            placeholder="example@gmail.com"
                                            id="password"
                                            value="<?php echo e(Cookie::get('superadmin_password')); ?>"
                                        />
...
<?php /**PATH E:\xampp\htdocs\Foodea_Website\resources\views/superadmin/superadmin_login.blade.php ENDPATH**/ ?>