      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <H3 class="font-weight-bolder mb-5"  style="color: #F54748"> PROFILE </H3> 
              ...
              <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                    ...
                    <div class="card-header">
                        padding-bottom
                        <a class="btn btn-link text-decoration-none get-started-btn " style="font-size: 15px;">Profile Details</a>
                      </div>
                        ...
                        <form class="forms-sample">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleCurrentPassword1">
                          </div>
                          padding-bottom
                          <div class="form-group">
                            <h6>New Password</h6>
                            <input type="NewPassword" class="form-control" id="exampleNewPassword1">
                          </div>
                          padding-bottom
                          <div class="form-group">
                            <h6>Password</h6>
                          ...
                          <div class="col-3 col-sm-2 col-xl-2 pl-0 text-center">
                            <span>
                              <button type="button" class="btn btn-danger btn-rounded btn-fw">Update</button>
                            </span>
                          </div>
                        </form>
...
<?php /**PATH E:\xampp\htdocs\Foodea_Website\resources\views/superadmin/superadmin_changepassword.blade.php ENDPATH**/ ?>