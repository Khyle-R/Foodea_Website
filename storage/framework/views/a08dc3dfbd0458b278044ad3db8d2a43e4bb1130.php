                                ...
                                <div class="container-fluid px-5">
                                  ...
                                  <div class="row align-items-center my-5">
                                    <div class="col-md-6 ml-5">
                                      ...
                                      <h2 class="red-name"> <?php echo e($partner->firstname . " ". $partner->lastname); ?> </h2>
                                      <h2 class="sub-text"><?php echo e($partner->vehicle_type); ?></h2>
                                      </div>
                                      </div>
                                    </div> 
                                    ...
                                    <div class="col-sm-5">
                                      ...
                                      <h4 class="yellow"><?php echo e($partner->status); ?></h4>
                                      </div>
                                      </div>
                                    </div>  
                                  </div>  
...
</html><?php /**PATH E:\xampp\htdocs\Foodea_Website\resources\views/partner_applicationstatus.blade.php ENDPATH**/ ?>