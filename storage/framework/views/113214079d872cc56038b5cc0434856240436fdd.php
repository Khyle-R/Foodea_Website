                    ...
                    <form class="form-sample" id="myForm_Business">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" style="border-radius: 10px;" value="<?php echo e($businessInfo->business_name); ?>">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" style="border-radius: 10px;"value="<?php echo e($businessInfo->barangay); ?>">
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" style="border-radius: 10px;"value="<?php echo e($businessInfo->business_type); ?>">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" style="border-radius: 10px;"value="<?php echo e($businessInfo->braches); ?>">
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" style="border-radius: 10px;"value="<?php echo e($businessInfo->address); ?>">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" style="border-radius: 10px;"value="<?php echo e($businessInfo->facebook_url); ?>">
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" style="border-radius: 10px;"value="<?php echo e($businessInfo->city); ?>">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="exampleTextarea1" rows="10" style="border-radius: 10px;">
                          <?php echo e($businessInfo->business_name); ?>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\Foodea_Website\resources\views/admin/admin_businessinformation1.blade.php ENDPATH**/ ?>