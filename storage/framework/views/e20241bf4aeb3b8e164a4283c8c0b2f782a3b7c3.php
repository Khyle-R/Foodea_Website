                                        ...
                                        <div class="row align-items-center my-5">
                                            <div class="col-md-6 ml-5">
                                                <div class="row align-items-center ">
                                                    ...
                                                    <img class="circle img-responsive mr-3" width="170" height="160"
                                        ...
                                        <div class="row justify-content-between">
                                            ...
                                            <div class="col-sm-5 mr-5">
                                                ...
                                                <div class="row px-3">
                                                    ...
                                                    <p class="black ml-5"><?php echo e($rider->vehicle_ownership); ?>
                                                    </p>
                                                </div>
                                                <div class="row px-3">
                                        ...
                                        <div class="row align-items-center justify-content-between mt-5">
                                            <div class="col-sm-5 ml-sm-5">
                                                ...
                                                <div class="row px-3 mt-2">
                                                    ...
                                                    <p class="black ml-5 spacing"><?php echo e($rider->rider_photo); ?>
                                                    </p>
                                                </div>
                                                <div class="row px-3 mt-2">
                                                ...
                                                <div class="row px-3 mt-2">
                                                    ...
                                                    <p class="black ml-5"><?php echo e($rider->cert_registration); ?>
                                                    </p>
                                                </div>
                                            ...
                                            <div class="col-sm-5 ml-sm-5">
                                                <div class="row px-2 mt-2">
                                                    ...
                                                    <a href="/rider_logout" class="button-red btn btn-lg"
                                                        data-toggle="modal" data-target="#exampleModalCenter">Sign
                                                        Out</a>
                                                    <?php else: ?>
                                                    <a href="/" class="button-red btn btn-lg" data-toggle="modal"
                                                        data-target="#exampleModalCenter">Done</a>
                                                    <?php endif; ?>
