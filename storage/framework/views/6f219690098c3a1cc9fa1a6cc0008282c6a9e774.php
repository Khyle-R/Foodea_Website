...
<?php $__env->startSection('content'); ?>
              ...
              <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                     ...
                     <div class="card-header">
                      ...
                      <a class="btn btn-link text-decoration-none get-started-btn " style="font-size: 15px;" href="admin_personalinformation1.html">Profile Information</a>
                    ...
                    <div class="card-body">
                    <form class="form-sample" id="myForm_Account">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" style="border-radius: 10px;" value="<?php echo e($accountInfo->firstname); ?>">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" style="border-radius: 10px;" value="<?php echo e($accountInfo->middlename); ?>">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" style="border-radius: 10px;" value="<?php echo e($accountInfo->email); ?>">
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10" style="padding-left: 15px;">
                              <input type="text" class="form-control" style="border-radius: 10px;" value="<?php echo e($accountInfo->lastname); ?>">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" style="border-radius: 10px;" value="<?php echo e($accountInfo->facebook_url); ?>">
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" style="border-radius: 10px;" value="<?php echo e($accountInfo->address); ?>">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="exampleTextarea1" rows="10" style="border-radius: 10px;" >
                          Mission
                          <?php echo e($accountInfo->mission); ?>

                          <br>
                          Vision
                          <?php echo e($accountInfo->vision); ?>
        ...
        <script>
          $( "#edit_info" ).click(function() {
            $("#myForm_Account :input").prop("disabled", false);
            $("#edit_info").hide(500);
            $("#save_info").show(500);
        });
        </script>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\Foodea_Website\resources\views/admin/admin_personalinformation1.blade.php ENDPATH**/ ?>