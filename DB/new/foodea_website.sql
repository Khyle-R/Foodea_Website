...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 23, 2023 at 08:04 AM
...
(5, '2023_02_22_075329_create_sessions_table', 2);
...
INSERT INTO `tbl_category` (`category_id`, `main_category`, `description`, `date`) VALUES
(2, 'SAMPLE', 'aaa', '2023-02-22 14:27:49'),
(4, 'Hello', 'xx', '2023-02-22 14:58:23');
...
CREATE TABLE `tbl_claimed` (
  ...
  `claimed_date` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tbl_inventory` (`inventory_id`, `merchant_id`, `product_name`, `stock`, `product_image`, `price`, `category_name`, `status`, `tags`, `description`, `ingredients`, `date`) VALUES
...
INSERT INTO `tbl_orders` (`order_id`, `customer_id`, `product_id`, `quantity`, `total`, `status`, `payment_type`, `date`) VALUES
(1, 1, 1, 1, 100.00, 'Pending', 'cash on delivery', '2023-02-22 16:47:47');
