...
<body>
    ...
    <section class="d-flex justify-content-center " data-aos="fade-up">
      <div class="content1 mx-auto d-flex flex-column align-items-center gap-4 pt-4 pb-2 py-xs-3 py-md-4 py-lg-5">
        ...
        <div class="paragraph1 w-75"><p class="text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Enim voluptas, ab dolore nostrum eius ut veritatis odio impedit, officia fugit quod sint repellendus adipisci ipsum accusamus quidem voluptates minus laboriosam maiores amet natus aut quas ad culpa. Eveniet, deleniti? At, nam iure alias et quos reiciendis esse ad molestias laboriosam.</p></div>
      </div>
    </section>
    <!-- END SECTION 1 -->
