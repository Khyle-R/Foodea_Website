...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="assets/css/superadmin_activitylog.css" />
    <!-- End layout styles -->
    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="superadmin_rider.html">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="superadmin_partner.html">
              <span class="menu-icon">
