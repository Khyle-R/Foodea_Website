...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/rider_term.css" />
  ...
  <body>
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <ul class="nav">
        ...
        <li class="red">Term of Use</li>
      </ul>
    </nav>
      <div class=" mt-5 row content-wrapper d-flex flex-column">
              <h2>Terms of Use</h2>
              ...
              <form action="/account_type">
                <div class="py-4">
                <input type="checkbox" name="checkbox3" value="yes" required>I have a professional driver's license.
                </input>
                <br>
                <input class="mt-3" type="checkbox" name="checkbox4" value="yes" required>I certify that have read the above disclaimers and agree to the rules.
                </input>
                </div>
                <br>
