                        ...
                        <div class="table-responsive">
                            ...
                            <tbody>
                              @foreach ($orders as $key => $data)
                                ...
                                <tr>
                                    <td>{{ $data[$key-1]->order_id}}</td>
                                    <td>{{ $data[$key-1]->customer_id}}</td>
                                    <td>{{ $data[$key-1]->order_key}}</td>
                                    <td>{{ $data[$key-1]->product_id}}</td>
                                    <td>{{ $data[$key-1]->date}}</td>
                                    <td>{{ $data[$key-1]->total}}</td>
                                    <td>
                                        <div class="dropdown action-label">
                                                <a class=" btn-white-circle btn-white btn-sm btn-rounded dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="false">
                                                    <i class=" pending mdi mdi-radiobox-marked"></i> {{ $data[$key-1]->status}}
                                                </a>
                                            <div class="bg-white dropdown-menu dropdown-menu-right">
                                                ...
                                                <a data-toggle="modal" data-target="#PreparingModal{{ $data[$key-1]->order_id}}" class="action-btn dropdown-item black" href="#"><i class="fa fa-dot-circle-o text-danger"></i> Ready for pick up</a>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="bg-white dropdown-menu dropdown-menu-right">
                                                <a data-toggle="modal" data-target="#ViewModal{{ $data[$key-1]->order_id}}" class="action-btn dropdown-item black" href="#"><i class="fa fa-pencil m-r-5"></i>View</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <!-- MODAL STARTS HERE -->
                                 <!-- VIEW CONTENT -->
                                 <div class="modal fade" tabindex="-1" id="ViewModal{{ $data[$key-1]->order_id}}" role="dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body text-dark">
                                                <div class="form-group">
                                                    ...
                                                    <input id="OrderNumber" name="OrderNumber" type="text" class="form-control" placeholder="{{ $data[$key-1]->order_id}}" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Customer ID</label>
                                                    <input id="CustomerId" name="CustomerId" type="text" class="form-control" placeholder="{{ $data[$key-1]->customer_id}}" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Product ID</label>
                                                    <input id="ProductId" name="ProductId" type="text" class="form-control" placeholder="{{ $data[$key-1]->product_id}}" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Quantity</label>
                                                    <input id="quantity" name="quantity" type="text" class="form-control" placeholder="{{ $data[$key-1]->quantity}}" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Total</label>
                                                    <input id="total" name="total" type="text" class="form-control" placeholder="{{ $data[$key-1]->total}}" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Status</label>
                                                    <input id="status" name="status" type="text" class="form-control" placeholder="{{ $data[$key-1]->status}}" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Payment type</label>
                                                    <input id="paymentType" name="paymentType" type="text" class="form-control" placeholder="{{ $data[$key-1]->payment_type}}" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Date</label>
                                                    <input id="date" name="date" type="text" class="form-control" placeholder="{{ $data[$key-1]->date}}" required>
                                                </div>
                                            </div>
                                            <!-- MODAL FOOTER -->
                                ...
                                <!-- PENDING MODAL -->
                                <div class="modal fade" id="PendingModal{{ $data[$key-1]->order_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <!-- MODAL HEADER -->
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <input type="hidden" name="order_id" id="order_id"  value="{{ $data[$key-1]->order_id}}">
                                            </div>
                                            <!-- MODAL FOOTER -->
                                            <div class="modal-footer">
                                ...
                                <!-- PREPARING MODAL -->
                                <div class="modal fade" id="PreparingModal{{ $data[$key-1]->order_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <!-- MODAL HEADER -->
                                            <div class="modal-header">
                                ...
                                <!-- DELIVERING MODAL -->
                                <div class="modal fade" id="DeliveringModal{{ $data[$key-1]->order_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <!-- MODAL HEADER -->
                                            <div class="modal-header">
                                ...
                                <!-- DELIVERED MODAL -->
                                <div class="modal fade" id="DeliveredModal{{ $data[$key-1]->order_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <!-- MODAL HEADER -->
                                            <div class="modal-header">
