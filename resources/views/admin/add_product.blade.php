                ...
                <div class="card px-3">
                  <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <form class="forms-sample" method="post" action="{{route('add_product.addProduct')}}" >
                          @csrf 
                          ...
                          <div class="form-group">
                            <div class="file-loading">
                              <input id="file-1" type="file" multiple class="file" data-overwrite-initial="false" data-min-file-count="1" data-theme="fa5"/>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-md">
